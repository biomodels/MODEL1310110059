# MODEL1310110059: MODEL1310110059
...
`pip install git+https://github.com/biomodels/MODEL1310110059.git`

To install a specific version (in this example, from the 2014-09-16 BioModels release)

`pip install git+https://github.com/biomodels/MODEL1310110059.git@20140916`

## Usage

Importing the model package.

`import MODEL1310110059 as model`
...
The model of stomach upper glandular cells metabolism is derived from the
...
and identified by:
[MODEL1310110059](http://identifiers.org/biomodels.db/MODEL1310110059) .
